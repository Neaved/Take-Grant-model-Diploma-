...
namespace System.Windows.Forms
{
    internal static class Helper
    {
            ...
            /*, bool straight = false*/, string penName)
        {
            ...
            //else
            DrawBezierLink(g, pt1.ToPointF(), pt2.ToPointF(), getPen(penName));
        }

        private static Pen getPen(string penName)
        {
            Pen pen;
            penDictionary.TryGetValue(penName, out pen);
            return pen;
        }

        private static void DrawStraightLink(Graphics g, PointF from, PointF to)
        {
            g.DrawLine(blackLinkPen, from, to);
        }

        private static void DrawBezierLink(Graphics g, PointF from, PointF to, Pen pen)
        {
            ...
            g.DrawBezier(pen, from, pt1, pt2, to);
        }
